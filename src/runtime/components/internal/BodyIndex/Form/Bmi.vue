...
import { inject, ref, useI18n, useObservations, useUserInfo } from '#imports'
...
<template>
  <form
    ...
    <!-- Input for Height -->
    <div class="flex flex-col">
      <label for="height" class="mb-1 first-letter:uppercase block text-sm font-medium"
      >{{ t('body-index.form.label.height') }} (cm)</label
      >
    ...
    <!-- Input for Weight -->
    <div class="flex flex-col">
      <label for="weight" class="mb-1 block first-letter:uppercase text-sm font-medium"
      >{{ t('body-index.form.label.weight') }} (kg)</label
      >
      <InputNumber
        id="weight"
