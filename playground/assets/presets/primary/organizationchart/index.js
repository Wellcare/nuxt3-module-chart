        ...
        class: [
            ...
            // Color
            {
                ...
                'border-surface-200 dark:border-surface-700':
                    !context?.selected,
                'text-primary dark:text-surface-0': context?.selected,
                'bg-primary dark:bg-primary/30': context?.selected,
                'border-primary dark:border-primary': context?.selected,
            },
            ...
            // States
            {
                ...
                'hover:bg-primary dark:hover:bg-primary/30':
                    context?.selectable && context?.selected,
            },
