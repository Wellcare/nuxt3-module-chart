    ...
    box: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-primary dark:bg-primary border-primary dark:border-primary text-white dark:text-surface-900':
                    props.modelValue,
            },
            ...
            // States
            {
                'peer-hover:bg-surface-50 dark:peer-hover:bg-surface-800/80 peer-hover:border-surface-200 dark:peer-hover:bg-surface-700 peer-hover:text-surface-700 dark:peer-hover:text-white/80':
                    !props.modelValue && !props.invalid,
                'peer-hover:bg-primary peer-hover:border-primary dark:peer-hover:bg-primary dark:peer-hover:border-primary':
                    props.modelValue,
                'peer-focus-visible:ring peer-focus-visible:ring-primary/50 dark:peer-focus-visible:ring-primary/50':
                    !props.disabled,
            },
