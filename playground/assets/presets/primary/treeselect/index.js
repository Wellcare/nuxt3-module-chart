    ...
    tree: {
        ...
        node: {
            class: [
                'p-1',
                'rounded-md',
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-inset focus:ring-primary/50 dark:focus:ring-primary/50',
            ],
        },
        content: ({ context, props }) => ({
            class: [
                ...
                {
                    'bg-primary dark:bg-primary/30 text-primary dark:text-surface-0':
                        context.selected,
                },
        ...
        toggler: ({ context }) => ({
            class: [
                ...
                'bg-transparent',
                {
                    ...
                    'text-primary dark:text-white': context.selected,
