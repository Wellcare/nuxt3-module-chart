export default {
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                (props.sortable === '' || props.sortable) && context.sorted
                    ? 'dark:text-white dark:bg-primary/30'
                ...
                'focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring focus-visible:ring-inset focus-visible:ring-primary/50 dark:focus-visible:ring-primary/50',
        ...
        sort: ({ context }) => ({
            class: [
                ...
                context.sorted ? 'dark:text-primary' : 'dark:text-white/80',
            ],
        }),
        ...
        filtermatchmodedropdown: {
            root: ({ state }) => ({
                class: [
                    ...
                    {
                        'outline-none outline-offset-0 ring ring-primary/50 dark:ring-primary/50':
                            state.focused,
                    },
        ...
        filterrowitem: ({ context }) => ({
            class: [
                ...
                {
                    'bg-primary dark:bg-primary/40 text-primary dark:text-white/80':
                        context?.highlighted,
                },
                {
                    'bg-primary dark:bg-primary/40 text-primary dark:text-white/80':
        ...
        filterapplybutton: {
            root: {
                class: [
                    ...
                    'hover:bg-primary dark:hover:bg-primary hover:border-primary dark:hover:border-primary',
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                // Color
                { 'bg-primary text-primary': context.active },
        ...
        rowtoggler: {
            class: [
                ...
                'focus-visible:ring focus-visible:ring-primary/50 dark:focus-visible:ring-primary/50',
                ...
                class: [
                    ...
                    // States
                    {
                        'peer-hover:border-primary dark:peer-hover:border-primary':
                            !props.disabled,
                        'peer-hover:border-primary dark:peer-hover:border-primary peer-hover:bg-primary dark:peer-hover:bg-primary':
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            // Color
            'dark:text-white/80',
            { 'bg-primary text-primary dark:bg-primary/30': context.selected },
            {
            ...
            // State
            {
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary/50 ring-inset dark:focus:ring-primary/50':
                    context.selectable,
            },
            {
    ...
    resizehelper: {
        class: 'absolute hidden w-[2px] z-20 bg-primary dark:bg-primary',
    },
}
