export default {
    ...
    button: ({ context, props }) => ({
        class: [
            ...
            // States
            'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary/50 dark:focus:ring-primary/50 focus:z-10',
            {
                'hover:bg-surface-50 dark:hover:bg-surface-800/80':
                    !context.active && !props.invalid,
                'hover:bg-primary dark:hover:bg-primary': context.active,
            },
            {
                'opacity-60 select-none pointer-events-none cursor-default':
                    context.disabled,
