export default {
    ...
    weeklabelcontainer: ({ context }) => ({
        class: [
            ...
            'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary/50 dark:focus:ring-primary/50',
            {
                'hover:bg-surface-100 dark:hover:bg-surface-800/80':
                    !context.selected && !context.disabled,
                'hover:bg-primary': context.selected && !context.disabled,
            },
            {
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-primary dark:text-primary': context.date.today,
                'text-surface-600 dark:text-white/70 bg-transparent':
                    !context.selected &&
                    !context.disabled &&
                    !context.date.today,
                'text-primary bg-primary dark:text-surface-0 dark:bg-primary/40':
                    context.selected && !context.disabled,
            },
