export default {
    ...
    toggler: {
        class: [
            ...
            'focus:outline-none focus:outline-offset-0 focus-visible:ring focus-visible:ring-primary/50 focus-visible:ring-inset dark:focus-visible:ring-primary/50',
